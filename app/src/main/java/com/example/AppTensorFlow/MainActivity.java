package com.example.AppTensorFlow;
...
import com.example.AppTensorFlow.ml.UTEQCampusLaMaria;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void Reconocimiento(View view){
        try {
            String[] etiquetas = {"Auditorio","Baños","Biblioteca","Centro Médico","Comedor","Facultad de Ciencias Agrarias y Forestales"
                    ,"Facultad de Ciencias de la Industria y Producción","Facultad de Ciencias de Ingeniería","Laboratorio de Acuicultura",
                    "Laboratorio Agroindustrial","Laboratorio Industrial", "Parqueadero","Polideportivo", "Laboratorio de Suelos"};

            UTEQCampusLaMaria model = UTEQCampusLaMaria.newInstance(getApplicationContext());
            TensorBuffer inputFeature0 = TensorBuffer.createFixedSize(new int[]{1, 224, 224, 3}, DataType.FLOAT32);
            inputFeature0.loadBuffer(convertirImagenATensorBuffer(mSelectedImage));

            UTEQCampusLaMaria.Outputs outputs = model.process(inputFeature0);
